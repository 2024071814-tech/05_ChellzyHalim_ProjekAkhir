...
<body>
    ...
    <div id="form">
        <div id="title">EDIT DATA CUSTOMER</div>
        <a href="showdata.php">KEMBALI</a>
        <br><br>
        <?php
        include 'koneksi.php';
        $id = $_GET['id'];
        $data = mysqli_query($koneksi,"SELECT * FROM isidata WHERE id='$id'");
        ...
        ?>
            ...
            <table class="art">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="text" name="menu1" value="<?php echo $d['menu1']; ?>"></td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="date" name="mealtime" value="<?php echo $d['mealtime']; ?>" required></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>:</td>
                    <td><input type="text" name="review" value="<?php echo $d['review']; ?>" required></td>
                </tr>
                <tr> 
